...
.. container:: warning
    ...
    **Warning:** The minor version ``1.0`` of ``v440`` has reached end-of-life.
...
If mode contains whitespace then it is split and tried sequentially until a submode is reached that does not raise an ``Exception``.
